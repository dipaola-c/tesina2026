...
- responde a gestos humanos,
    
- tiene un rango de control relativamente estable,
...
- impone condiciones sonoras propias,
...
Por eso la pregunta que planteás es clave:

Si la máquina sugiere los suyos… ¿qué sesgo tiene la máquina?
...
En tu marco, “máquina” no equivale solamente a computadora.

Puede ser:

- un sistema de transductores (Tudor, Rainforest),
    
- un circuito analógico inestable (Mumma),
    
- un sistema de azar estructurado (Cage),
